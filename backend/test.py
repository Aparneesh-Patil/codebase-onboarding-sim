...
zip_id = zip_storage.hash_file("./data/Multithreaded-Web-Server.zip")
...
loaded_files = analyzer.load_file("./data/Multithreaded-Web-Server.zip", important_files, zip_id)
